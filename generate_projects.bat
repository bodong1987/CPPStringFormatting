...
cmake -G "Visual Studio 17 2022" -A Win32 -S %PROJECT_ROOT% -B %BUILD_DIR%\vs2022_x86
if %errorlevel% neq 0 (
...
cmake -G "Visual Studio 17 2022" -A x64 -S %PROJECT_ROOT% -B %BUILD_DIR%\vs2022_x64
if %errorlevel% neq 0 (
...
if %CODEBLOCKS_FOUND% equ 1 (
    ...
    cmake -G "CodeBlocks - MinGW Makefiles" -S %PROJECT_ROOT% -B %BUILD_DIR%\CodeBlocks
    if %errorlevel% neq 0 (
